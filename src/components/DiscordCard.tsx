...
const DiscordCard = ({ section }) => {
	return (
		<motion.a
			href="https://discord.gg/pPTEteRG"
			target="_blank"
			rel="noreferrer"
			...
			className="rounded-2xl bg-indigo-300 dark:bg-indigo-800 flex justify-center items-center col-span-1 relative aspect-square group"
		>
			...
			rotate-45 mb-2 mr-2 w-8 h-8 hover:text-white" />
		</motion.a>
	)
}
