...
const SpotifyCard = ({ section }) => {
  ...
  return (
    <motion.a
      ...
      className="flex bg-white relative dark:bg-gray-900 rounded-2xl md:col-span-1 col-span-2 overflow-hidden"
    ...
    >
      <div className="flex flex-col text-gray-900 dark:text-gray-100 justify-center xl:ml-7 md:ml-5 mt-5 xl:mt-none ml-4">
        <div className="text-[#62DBBE] dark:text-[#1E856D] xl:text-xl  lg:text-lg text-sm font-bold">
          Currently Listening
        </div>
        ...
        <div className="absolute text-[#62DBBE] dark:text-[#1E856D] first-letter: fill-current top-0 left-0 m-2 md:m-5 rotate-20 hover:rotate-40 transition lg:w-[30px] lg:h-[30px] w-[20px] h-[20px]">
        <svg
          viewBox="0 0 256 256"
          version="1.1"
      ...
      <div className="absolute bottom-0 right-0 rounded-tl-full overflow-hidden dark:brightness-75">
        <img
          ...
          style={{ display: data?.albumImageUrl ? "block" : "none" }}
        />
      </div>
    </motion.a>
  );
