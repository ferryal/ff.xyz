  ...
  return (
    ...
    >
      <div className="flex flex-col text-gray-900 dark:text-gray-100 justify-center xl:ml-7 md:ml-5 mt-5 xl:mt-none ml-4">
        <div className="text-[#62DBBE] dark:text-[#1E856D] xl:text-sm lg:text-sm text-sm font-bold">
          {data?.isPlaying ? "Currently Listening" : "Currently Not Listening"}
        </div>
        {data?.isPlaying && (
          <>
            <div className="items-center justify-center xl:text-lg lg:text-lg text-xs font-semibold truncate w-52 md:w-40 xl:w-56">
              {data?.title || "loading..."}
            </div>
            <div className="items-center justify-center xl:text-lg lg:text-lg text-xs font-light">
              {data?.artist || ""}
            </div>
          </>
        )}
      ...
      {data?.isPlaying && (
        <div className="absolute bottom-0 right-0 rounded-tl-full overflow-hidden dark:brightness-75">
          <img
            ...
            className="xl:w-32 xl:h-32 lg:w-28 lg:h-28 h-20 md:block"
